...
public class CurriculumClientImpl implements CurriculumClient {
    ...
    @Override
    public CompletableFuture<Student> getStudent(int id) throws ResourceException {
        ...
        AsyncHandler<Student> asyncHandler = new DefaultAsyncCompletionHandler<>(Student.class);
